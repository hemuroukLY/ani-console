...
This project is indexed by GitNexus as **ani-console** (3052 symbols, 7973 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
